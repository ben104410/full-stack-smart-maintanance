      ...
      <header className="border-b-4 border-[#f37021] bg-[#002147] shadow-xl">
        <div className="mx-auto flex h-24 max-w-7xl items-center justify-between px-8">
          <Link to="/" className="flex items-center gap-3">
            ...
            <span className="text-xl font-extrabold uppercase italic text-white">Pwani <span className="text-[#f37021]">Maint</span></span>
          </Link>
          <Link to="/" className="text-xs font-bold uppercase tracking-widest text-white hover:text-orange-400">Back Home</Link>
        </div>
      </header>

      <main className="mx-auto max-w-3xl px-6 py-24 text-center">
        <span className="text-xs font-bold uppercase tracking-[0.25em] text-[#f37021]">Support Center</span>
        <h1 className="mt-4 mb-10 text-4xl font-extrabold tracking-tight text-[#002147] md:text-5xl">Institutional Support</h1>
        ...
        <div className="grid gap-6">
          <div className="rounded-3xl bg-white p-10 shadow-sm border border-slate-100">
            ...
            <a href="mailto:support@pwani-maint.local" className="text-2xl font-extrabold tracking-tight text-[#f37021] hover:underline">
